...
Pull request [#63](https://github.com/ros-industrial/abb_libegm/pull/63) turned this package from a Catkin package, into a plain CMake package. ROS users can utilize any of the following build tools to build the source code:
